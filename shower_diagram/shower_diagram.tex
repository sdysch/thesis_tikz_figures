...
% TODO - hadronisation to particles + decay?
	...
	\draw[color = blue, thick, fill = blue] (0.8 * \UEHadXBase, 1.2 * \UEHadYBase) circle [x radius = \verySmallEllipseRx, y radius = \verySmallEllipseRy, rotate = 120];
	\draw[color = blue, thick, fill = blue] (-0.8 * \UEHadXBase, 1.2 * \UEHadYBase) circle [x radius = \verySmallEllipseRx, y radius = \verySmallEllipseRy, rotate = 50];
	...
	\draw[color = blue, thick, fill = blue] (-0.5, \gluonGluonVertexY) circle [x radius = \verySmallEllipseRx, y radius = \verySmallEllipseRy];
