\begin{tikzpicture}
	...
	% gluons in UE
	%\draw[smallGluon, color = orange] (\UEPositionX + 0.1, \UEPositionY - 0.1) -- (0.8 * \UEHadXBase + 0.1, 1.2 * \UEHadYBase + 0.1);
	...
	\draw[color = blue, thick, fill = blue] (0.5, \quarkGluonVertexY) circle [x radius = \verySmallEllipseRx, y radius = \verySmallEllipseRy];
