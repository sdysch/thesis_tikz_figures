\begin{tikzpicture}
	...
	\tikzset{
		hadronisation/.code args = {#1, #2, #3}{%
			...
			\draw[dashed, color = green, rotate around = {#3 + \manualRotationOffset:(#1, #2)}] (#1 + 0.5 , #2 - 0.5) -- (#1 + 0.95, #2 - 0.75);
			\draw[dashed, color = green, rotate around = {#3 + \manualRotationOffset:(#1, #2)}] (#1 + 0.5 , #2 - 0.5) -- (#1 + 0.75, #2 - 0.95);
			\draw[color = black, fill = green, rotate around = {#3 + \manualRotationOffset:(#1, #2)}] (#1 + 0.95, #2 - 0.75) circle (0.05);
			\draw[color = black, fill = green, rotate around = {#3 + \manualRotationOffset:(#1, #2)}] (#1 + 0.75, #2 - 0.95) circle (0.05);
	...
	\tikzset{
		hadronisation2/.code args = {#1, #2, #3}{%
			...
			% big particle decay
			\draw[dashed, rotate around = {#3 + \manualRotationOffset:(#1, #2)}, color = green] (#1, #2) -- (#1 + 0.3 , #2 - 0.7);
			\draw[dashed, color = green, rotate around = {#3 + \manualRotationOffset:(#1, #2)}] (#1 + 0.3 , #2 - 0.7) -- (#1 + 0.75, #2 - 0.95);
			\draw[dashed, color = green, rotate around = {#3 + \manualRotationOffset:(#1, #2)}] (#1 + 0.3 , #2 - 0.7) -- (#1 + 0.55, #2 - 1.15);
			\draw[color = black, rotate around = {#3 + \manualRotationOffset:(#1, #2)}, fill = green] (#1 + 0.3 , #2 - 0.7) circle (0.075);
			\draw[color = black, fill = green, rotate around = {#3 + \manualRotationOffset:(#1, #2)}] (#1 + 0.75, #2 - 0.95) circle (0.05);
			\draw[color = black, fill = green, rotate around = {#3 + \manualRotationOffset:(#1, #2)}] (#1 + 0.55, #2 - 1.15) circle (0.05);
			% little particle
			\draw[dashed, rotate around = {#3 + \manualRotationOffset:(#1, #2)}, color = green] (#1, #2) -- (#1 + 0.7 , #2 - 0.3);
			\draw[color = black, rotate around = {#3 + \manualRotationOffset:(#1, #2)}, fill = green] (#1 + 0.7 , #2 - 0.3) circle (0.05);
			% ellipse for hadronization vertex
	...
	% 0.5 = sin (30)
	\draw[smallGluon, color = magenta, thick] (\hardScatterX - \hardScatterRadius * 0.70710678118, \hardScatterY + \hardScatterRadius * 0.70710678118) -- (\hardScatterX - 1.5, \hardScatterY + 1.5);
	\draw[color = magenta, thick] (\hardScatterX + \hardScatterRadius * 0.70710678118, \hardScatterY + \hardScatterRadius * 0.70710678118) -- (\hardScatterX + 1.5, \hardScatterY + 1.5);
	\draw[color = magenta, thick] (\hardScatterX, \hardScatterY + \hardScatterRadius) -- (\hardScatterX, \hardScatterY + 1.5);
	\draw[color = magenta, thick] (\hardScatterX - \hardScatterRadius * 0.5, \hardScatterY + \hardScatterRadius * 0.86602540378) -- (\hardScatterX - 1, \hardScatterY + 1.5);
	\draw[smallGluon, color = magenta, thick] (\hardScatterX + \hardScatterRadius * 0.5, \hardScatterY + \hardScatterRadius * 0.86602540378) -- (\hardScatterX + 1, \hardScatterY + 1.5);

	\draw[color = black, fill = magenta, thick] (\hardScatterX + 1.5, \hardScatterY + 1.5) circle (0.5 * \hardScatterRadius);
	\draw[color = black, fill = magenta, thick] (\hardScatterX, \hardScatterY + 1.5) circle (0.5 * \hardScatterRadius);
	\draw[color = black, fill = magenta, thick] (\hardScatterX - 1, \hardScatterY + 1.5) circle (0.5 * \hardScatterRadius);
