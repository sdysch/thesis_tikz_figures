...
% TODO - hadronisation to particles + decay?
	...
	\foreach \i in {-0.3, -0.2, -0.1, 0, 0.1, 0.2, 0.3} \draw[color = green, thick] (\UEHadXBase, \UEHadYBase) -- (\UEHadXBase + 0.5 + \i , \UEHadYBase - 0.5 + \i);
	...
	% hadronisation
	\draw[hadronisation = {0.5, \quarkGluonVertexY, 0}];
	\draw[hadronisation = {-0.5, \gluonGluonVertexY, 0}];
