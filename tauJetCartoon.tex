...
\begin{document}
	...
	\begin{tikzpicture}[scale=\tauJetScale]
		...
		\def\ryy{0.2}% vertical radius of the ellipse
		...
		\begin{scope}
			...
			% tau cone
			\draw[fill = green!80, green!80] (intersection-1) -- (0,0) -- (intersection-2) -- cycle;
			% base of tau cone in ball
			\draw[fill = green!60, densely dashed] (0,\z) ellipse ({\rx} and {\ry});
		...
		%isolation cone
		\draw[fill = blue!90, blue!90, opacity = 0.4] (intersection-1) -- (0,0) -- (intersection-2) -- cycle;
		\draw[fill = blue!30, densely dashed] (0,\zz) ellipse ( {\rxx} and {\ryy} );
	...
	\begin{tikzpicture}[scale=\tauJetScale]
		...
		\draw[-] (0,0) ..  controls (0.1, 0.5) and (0.15, 1.5) .. (0.3, 2.0);% charged pions
		\draw[-] (0,0) ..  controls (-0.1, 0.5) and (-0.15, 1.5) .. (-0.3, 2.0);
		\draw[-] (0,0) ..  controls (-0.05, 0.5) and (-0.1, 1.5) .. (-0.17, 2.0);
